...
<div class="row">
  ...
  <p><font size=6 style = "font-family:Copperplate; background-color:blue; color:white" >MAPA DE CANDIDATOS PROVINCIALES</font></p>
  </div>
  <div class="col-md-2 text-center">
    <img src="https://www.gifservice.fr/img/gif-vignette-small/174c52f068e802394d5eb4aee0b9fc2a/205254-banderas-america-ecuador-smiley-ok.gif" alt="NAYEEEEEE" height="70" width="150">
  </div>
  ...
  function initMap() {
    ...
    <?php if ($lugares2): ?>
      ...
      marcadores.forEach(function (marcador) {
        console.log(2);
        marcador.setMap(mapaLugaresProvincial);
      });
